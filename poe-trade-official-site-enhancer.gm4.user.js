  ...
  <div class="container pt-1">
    ...
    <div class="tab-content" id="myTabContent">
      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        <div class="">
          <h2 class="">Poe Trade Official Site Enhancer <small class="text-secondary font-italic font-weight-light">v. 1.3.73</small></h2>
...
info("version: 1.3.73");
  ...
  eval(await GM.getResourceText("editableJs"));
...
var startAllSockets = function (resources) {
  ...
  $.each( resources, function( index, res ) {
    setTimeout(function(){ var connection = startSocket(index, res); }, (index * 1000) + 100);
  });
};
    ...
    if (!curr || !updated || (maxAge > 0 && moment.duration(moment().diff(updated)).asHours() >= maxAge)) {
      ...
      $.when(
        ...
        $.each( arguments, function( i, response ) {
          debug("await GM.xmlhttpRequest response", response);
        ...
        debug("await GM.xmlhttpRequest errors", arguments);
        cb(null);
      });
    } else {
